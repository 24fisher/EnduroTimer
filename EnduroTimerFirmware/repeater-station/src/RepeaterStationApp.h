...
private:
  ...
  struct RelayPacket { String payload; String mid; uint8_t priority = 2; uint8_t hop = 0; uint32_t enqueueMs = 0; };
  ...
  bool enqueueRelay(const String& payload, const String& mid, uint8_t priority, uint8_t hop);
